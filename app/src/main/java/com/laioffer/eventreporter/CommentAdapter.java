...
/**
 * Created by Prectrum on 12/27/17.
 */
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    public class CommentViewHolder extends RecyclerView.ViewHolder {
        public TextView commentUser; //android:id="@+id/comment_item_user"
        public TextView commentTime; //android:id="@+id/comment_item_time"
        public TextView commentDescription; //android:id="@+id/comment_item_description"
